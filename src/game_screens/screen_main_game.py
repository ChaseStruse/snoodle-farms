...
def main_game_screen(game, player_state):
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if pressed[pygame.K_1]:
                game.player_state.inventory.selected_item = game.player_state.inventory.current_items["0"]["plant"]
                game.player_state.inventory.selected_item_key = "0"
            if pressed[pygame.K_2]:
                game.player_state.inventory.selected_item = game.player_state.inventory.current_items["1"]["plant"]
                game.player_state.inventory.selected_item_key = "1"
            elif pressed[pygame.K_9]:
                player_state.state = GameStates.SHOP_STATE.value
